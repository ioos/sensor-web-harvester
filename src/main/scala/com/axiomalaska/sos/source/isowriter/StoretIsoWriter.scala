...
class StoretIsoWriter(private val stationQuery:StationQuery, 
  ...
  override def getSensorTagsAndNames(station: LocalStation) : List[(String,String)] = {
    ...
    val retval = (splitLines map { _.zipWithIndex } flatten) map { s=> s._2 match { case 31 => ( s._1, s._1 ); case _ => ( "", "" ) } } filter { _._1.length > 0 } groupBy { _._1 } map { _._2.head } toList;
  ...
  */
  ...
  override def getContacts(station: LocalStation): List[Contact] = {
    List(
      new Contact(wqpIndividualName,wqpOrgName,null,null,null,null,null,wqpEmail,wqpWebId,wqpWebAddress,"distributor"),
      new Contact(storetIndividualName,storetOrgName,storetPhone,null,storetCity,storetState,null,storetEmail,storetWebId,storetWebAddress,"originator")
    )
  }
  ...
  private def getStationName() : String = {
    ...
    val retval = (splitLines map { _.zipWithIndex } flatten).foldRight(("", 0))((a,b) => { b._2 match { case 3 => (b._1, b._2); case _ => (a._1, a._2) } } )._1.replaceAll("\"","")
    retval.replaceAll("\0", ",")
  }
  ...
  private def getStationID(station: LocalStation) : String = {
    ...
    val retval = (splitLines map { _.zipWithIndex } flatten).foldRight(("", 0))((a,b) => { b._2 match { case 2 => (b._1, b._2); case _ => (a._1, a._2) } } )._1.replaceAll("\"","")
    retval.replaceAll("\0", ",")
  }
